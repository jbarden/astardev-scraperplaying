...
/// <summary>Interface for processing images by downloading and handling them asynchronously.</summary>
public interface IImageProcessor
{
    /// <summary>Downloads an image asynchronously based on the provided parameters.</summary>
    ...
    /// <summary>Processes the image asynchronously based on the provided parameters.</summary>
