...
{
    /// <summary>Decodes the image at <paramref name="filePath"/>, scales it down so neither side exceeds <paramref name="maxDimension"/> (never up), and re-encodes it as PNG.</summary>
    /// <param name="filePath">The path of the image file to decode.</param>
    /// <param name="maxDimension">The largest width or height, in pixels, of the returned image.</param>
    ...
    Stream DecodeToPng(string filePath, int maxDimension);
}
