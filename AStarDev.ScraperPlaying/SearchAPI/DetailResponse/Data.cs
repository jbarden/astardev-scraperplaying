...
public record Data(
    string Id,
    string Url,
    [property: JsonPropertyName("short_url")] string ShortUrl,
    Uploader Uploader,
    int Views,
    int Favorites,
    string Source,
    string Purity,
    string Category,
    [property: JsonPropertyName("dimension_x")] int DimensionX,
    [property: JsonPropertyName("dimension_y")] int DimensionY,
    string Resolution,
    string Ratio,
