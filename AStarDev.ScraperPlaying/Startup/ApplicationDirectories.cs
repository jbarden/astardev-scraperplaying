...
/// <summary>The <see cref="ApplicationDirectories" /> class provides access to the application's data, cache, and log directories, ensuring they exist and are accessible.</summary>
...
public class ApplicationDirectories(IFileSystem fileSystem, ILogger<ApplicationDirectories> logger) : IApplicationDirectories
{
    ...
    /// <summary>Initializes a new instance of the <see cref="ApplicationDirectories" /> class, ensuring that the necessary application directories exist.</summary>
    ...
    /// <summary>Gets the directory for cached data, typically located in the user's application data folder.</summary>
    public static string CacheDirectory => root.CombinePath("cache");

    /// <summary>Gets the directory for log files, typically located in the user's application data folder.</summary>
