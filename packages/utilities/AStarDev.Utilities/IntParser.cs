...
{
    /// <summary>The ToInt method will parse the supplied string and return the matching int value</summary>
    ...
    /// <summary>The ToIntSafe method will parse the supplied string and return the matching int value, or 0 if the string is not a valid int value</summary>
    /// <param name="value">The value to parse to the int</param>
