namespace AStarDev.TechnicalDebtReporting;

/// <summary>The <see cref="RefactorAttribute" /> attribute</summary>
...
{
    /// <summary>The estimated hours to resolve</summary>
    public int HoursToResolve { get; } = hoursToResolve;

    /// <summary>Gets the description of the refactoring to be performed</summary>
    public string Description { get; } = description;

    /// <summary>The estimated pain level - quantity to be defined</summary>
