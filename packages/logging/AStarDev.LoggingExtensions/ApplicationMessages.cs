...
/// <summary>Provides extension methods for logging common application lifecycle events, such as starting up and shutting down, with consistent formatting and event IDs.</summary>
public static partial class ApplicationMessages
{
    /// <summary>Logs an application starting-up.</summary>
    ...
    /// <summary>Logs an application stopping.</summary>
    /// <param name="logger">The logger to be used for logging the event.</param>
    ...
    /// <summary>Logs a successful application start-up.</summary>
    /// <param name="logger">The logger to be used for logging the event.</param>
