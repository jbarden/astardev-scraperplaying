...
/// <summary>An attribute to automatically register a minimal APU endpoint.</summary>
/// <remarks>
...
{
    /// <summary>Gets the HTTP method type associated with the endpoint.</summary>
    /// <remarks>If no specific HTTP method is provided during initialization, the default value is <see cref="HttpMethod.Get"/>.</remarks>
    /// <value>Represents the HTTP method used for the endpoint, as an instance of the <see cref="HttpMethod"/> class.</value>
    public HttpMethod MethodType { get; } = methodType ?? HttpMethod.Get;

    /// <summary>Gets the group name associated with the method for organizational purposes.</summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <value>Represents the name of the method group as a <see cref="string"/>. Can be <see langword="null"/> if not explicitly set.</value>
